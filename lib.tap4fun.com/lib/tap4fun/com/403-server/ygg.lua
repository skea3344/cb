...
module.WriteCreepAttr = function(stream,val)
	...
	if val.AddType == nil then
		error("expect CreepAttr#AddType")
	end
	stream:WriteByte(val.AddType)
	...
	if val.MaxDropKind == nil then
		error("expect CreepAttr#MaxDropKind")
	end
...
module.ReadCreepDrop = function(stream)
	...
	val.ItemID = stream:ReadString()
	
	val.KingdomDrop = stream:ReadByte()
	
	val.DropPro = stream:ReadUint16()
	
	val.DropNum = stream:ReadUint16()
...
module.WriteCreepDrop = function(stream,val)
	...
	stream:WriteString(val.ItemID)
	
	if val.KingdomDrop == nil then
		error("expect CreepDrop#KingdomDrop")
	end
	stream:WriteByte(val.KingdomDrop)
	...
	stream:WriteUint16(val.DropNum)
...
module.WriteItem = function(stream,val)
	...
	if val.ID == nil then
		error("expect Item#ID")
	end
	stream:WriteString(val.ID)
	
	if val.Name == nil then
		error("expect Item#Name")
	end
	stream:WriteString(val.Name)
	
	if val.Type == nil then
		error("expect Item#Type")
	end
	stream:WriteUint16(val.Type)
	
	if val.Value == nil then
		error("expect Item#Value")
	end
	stream:WriteUint16(val.Value)
...
module.ReadPlayerInfo = function(stream)
	...
	val.GuardHero = module.ReadHero(stream)
...
module.WritePlayerInfo = function(stream,val)
	...
	if val.GuardHero == nil then
		error("expect PlayerInfo#GuardHero")
	end
	module.WriteHero(stream,val.GuardHero)
	...
	if val.Marches == nil then
		error("expect PlayerInfo#Marches")
	end
	
	local f = function(arg)
		stream:WriteUint16(#arg)
		for i,v in ipairs(arg) do
			module.WriteMarch(stream,v)
		end
	end
	f(val.Marches)
...
module.WriteArmy = function(stream,val)
	...
	if val.Exp == nil then
		error("expect Army#Exp")
	end
	stream:WriteFloat32(val.Exp)
...
module.WriteCityStatusInfo = function(stream,val)
	...
	if val.PlayerName == nil then
		error("expect CityStatusInfo#PlayerName")
	end
	stream:WriteString(val.PlayerName)
...
module.WriteResourceStatusInfo = function(stream,val)
	...
	if val.PlayerName == nil then
		error("expect ResourceStatusInfo#PlayerName")
	end
	stream:WriteString(val.PlayerName)
...
module.WriteCreepStatusInfo = function(stream,val)
	...
	if val.Name == nil then
		error("expect CreepStatusInfo#Name")
	end
	stream:WriteString(val.Name)
...
module.WriteGarrisonStatusInfo = function(stream,val)
	...
	if val.PlayerName == nil then
		error("expect GarrisonStatusInfo#PlayerName")
	end
	stream:WriteString(val.PlayerName)
	...
	if val.Power == nil then
		error("expect GarrisonStatusInfo#Power")
	end
	stream:WriteUint32(val.Power)
...
module.GS.QueryCity = function(arg0,callback)
	...
	call.Return:Add(function(e,params)
		...
		local arg4 = stream:ReadString()
		
		local stream = params[5]
		local arg5 = stream:ReadByte()
		
		callback(nil,arg0,arg1,arg2,arg3,arg4,arg5)
	end)
...
module.GS.ServerTime = function(callback)
	local call = gsnet:NewCall(2)
...
module.GC.Call = function(call)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.HeroesChanged(arg0)
	...
	if call.Method == 1 then
		...
		err =  module.GC.metatable.MoneyChanged(arg0)
	...
	if call.Method == 4 then
		...
		err =  module.GC.metatable.OnMarchChanged(arg0)
	...
	if call.Method == 6 then
		...
		err =  module.GC.metatable.OnMarchFlagChanged(arg0,arg1)
	...
	if call.Method == 5 then
		...
		err =  module.GC.metatable.OnMarchTargetChanged(arg0,arg1)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.OnViewDataEnter(arg0)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.OnViewDataLeave(arg0)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.OnViewDataMoved(arg0)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.OnViewMarchEnter(arg0)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.OnViewMarchLeave(arg0)
	...
	local arg0 = f()
		...
		local ret0 = module.GC.metatable.RecvMail(arg0)

		
		local stream = call:NewReturn()
		module.WriteErr(stream,ret0)
	...
	if call.Method == 14 then
		...
		err =  module.GC.metatable.RecvMessageAlliance(arg0,arg1)
	...
	if call.Method == 12 then
		...
		err =  module.GC.metatable.RecvMessageMap(arg0,arg1)
	...
	if call.Method == 15 then
		...
		err =  module.GC.metatable.RecvMessagePrivate(arg0,arg1)
	...
	if call.Method == 13 then
		...
		err =  module.GC.metatable.RecvMessageWorld(arg0,arg1)
	...
	local arg0 = f()
		...
		local ret0 = module.GC.metatable.RecvNotice(arg0)
	...
	local arg0 = f()
		...
		local ret0 = module.GC.metatable.RecvReport(arg0)
	...
	if call.Method == 0 then
		...
		err =  module.GC.metatable.ResourceChanged(arg0)
	...
	if call.Method == 19 then
		...
		err =  module.GC.metatable.SetCityStatusInfo(arg0)
	...
	if call.Method == 21 then
		...
		err =  module.GC.metatable.SetCreepStatusInfo(arg0)
	...
	if call.Method == 22 then
		...
		err =  module.GC.metatable.SetGarrisonStatusInfo(arg0)
	...
	if call.Method == 20 then
		...
		err =  module.GC.metatable.SetResourceStatusInfo(arg0)
	...
	local arg0 = f()
		...
		err =  module.GC.metatable.UnitsChanged(arg0)
...
module.ReadFacilitySkill = function(stream)
	local val = {}
	...
	val.ProDegree = stream:ReadUint16()
	
	val.SoloProUp = stream:ReadUint16()
	
	val.OnceNumUp = stream:ReadUint16()
	
	val.ProNum = stream:ReadUint16()
	
	val.PileUp = stream:ReadUint16()
...
module.WriteFacilitySkill = function(stream,val)
	
	if val.ID == nil then
		error("expect FacilitySkill#ID")
	end
	stream:WriteString(val.ID)
	
	if val.Type == nil then
		error("expect FacilitySkill#Type")
	end
	stream:WriteUint16(val.Type)
	
	if val.Name == nil then
		error("expect FacilitySkill#Name")
	end
	stream:WriteString(val.Name)
	
	if val.ProDegree == nil then
		error("expect FacilitySkill#ProDegree")
	end
	stream:WriteUint16(val.ProDegree)
	
	if val.SoloProUp == nil then
		error("expect FacilitySkill#SoloProUp")
	end
	stream:WriteUint16(val.SoloProUp)
	
	if val.OnceNumUp == nil then
		error("expect FacilitySkill#OnceNumUp")
	end
	stream:WriteUint16(val.OnceNumUp)
	
	if val.ProNum == nil then
		error("expect FacilitySkill#ProNum")
	end
	stream:WriteUint16(val.ProNum)
	
	if val.PileUp == nil then
		error("expect FacilitySkill#PileUp")
	end
	stream:WriteUint16(val.PileUp)
	
	if val.EffectVal == nil then
		error("expect FacilitySkill#EffectVal")
	end
	stream:WriteUint32(val.EffectVal)
...
module.ReadHeroAttr = function(stream)
	...
	val.DefEnhance = stream:ReadUint16()
...
module.WriteHeroAttr = function(stream,val)
	...
	if val.DefStar == nil then
		error("expect HeroAttr#DefStar")
	end
	stream:WriteUint16(val.DefStar)
	
	if val.DefEnhance == nil then
		error("expect HeroAttr#DefEnhance")
	end
	stream:WriteUint16(val.DefEnhance)
